      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <div className={`h-2 w-full rounded-lg ${trackColor}`}>
            ...
            {showProgress && (
              <div
                className={`h-full rounded-lg ease-out ${progressColor}`}
