  ...
  return (
    <>
      {createPortal(
        ...
        >
          {/* Arka plan */}
          <div className="pointer-events-auto absolute inset-0 z-34 bg-black-40" />
          ...
          >
            <div className="pointer-events-auto w-72 border border-gray-200 bg-box-surface shadow-lg">
...
function MenuItem({ label, description, value, onClick, showChevron, control }: any) {
  return (
    ...
    >
      ...
      <div className="flex items-center">
        {value && <span className="mr-2 text-gray-800">{value}</span>}
        {control}
