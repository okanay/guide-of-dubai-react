...
export const PublicHeader = () => {
  return (
    <header>
      <div className="relative z-20 lg:px-4">
        <nav className="mx-auto flex max-w-8xl items-center justify-between">
          ...
          <div
            ...
            className="hidden items-center gap-x-1.5 overflow-x-auto text-size-sm font-semibold text-[#ffffff] lg:flex"
          >
            <button className="mr-2 rounded-full border border-[#ffffff] bg-transparent px-2 py-2 text-[#ffffff] transition-colors duration-300 ease-in-out hover:bg-btn-primary-hover hover:text-on-btn-primary focus:bg-btn-primary-focus focus:text-on-btn-primary">
              <svg
              ...
              >
                <path
                  d="M14.7 15.75L9.975 11.025C9.6 11.325 9.16875 11.5625 8.68125 11.7375C8.19375 11.9125 7.675 12 7.125 12C5.7625 12 4.60938 11.5281 3.66563 10.5844C2.72188 9.64063 2.25 8.4875 2.25 7.125C2.25 5.7625 2.72188 4.60938 3.66563 3.66563C4.60938 2.72188 5.7625 2.25 7.125 2.25C8.4875 2.25 9.64063 2.72188 10.5844 3.66563C11.5281 4.60938 12 5.7625 12 7.125C12 7.675 11.9125 8.19375 11.7375 8.68125C11.5625 9.16875 11.325 9.6 11.025 9.975L15.75 14.7L14.7 15.75ZM7.125 10.5C8.0625 10.5 8.85938 10.1719 9.51563 9.51563C10.1719 8.85938 10.5 8.0625 10.5 7.125C10.5 6.1875 10.1719 5.39063 9.51563 4.73438C8.85938 4.07813 8.0625 3.75 7.125 3.75C6.1875 3.75 5.39063 4.07813 4.73438 4.73438C4.07813 5.39063 3.75 6.1875 3.75 7.125C3.75 8.0625 4.07813 8.85938 4.73438 9.51563C5.39063 10.1719 6.1875 10.5 7.125 10.5Z"
                  fill="#F8F8F8"
                />
              </svg>
            </button>
            <button className="group btn-default -mr-1 flex items-center rounded-full px-2 py-1">
              <span>Tüm Kategoriler</span>
              <ChevronDown className="ml-2 rounded-full text-primary-500 transition-colors duration-300 ease-in-out group-hover:bg-btn-primary group-hover:text-on-btn-primary group-focus:bg-btn-primary-focus group-focus:text-on-btn-primary hover:bg-btn-primary-hover" />
            </button>
            <button className="btn-default rounded-full px-2 py-1">Sepetim</button>
            <Link to="/$lang">
            ...
            <button className="btn-default rounded-full px-2 py-1">Go.Ai</button>
            <button className="group btn-default flex items-center rounded-full px-2 py-1">
              <span>Türkçe</span>
              <span className="mx-2">-</span>
              <span>TL</span>
              <ChevronDown className="ml-2 rounded-full text-primary-500 transition-colors duration-300 ease-in-out group-hover:bg-btn-primary group-hover:text-on-btn-primary group-focus:bg-btn-primary-focus group-focus:text-on-btn-primary hover:bg-btn-primary-hover" />
            </button>
            <button className="ml-2 bg-btn-primary px-4.5 py-2 text-on-btn-primary transition-colors duration-300 ease-in-out hover:bg-btn-primary-hover focus:bg-btn-primary-focus disabled:bg-btn-primary-disabled">
              Login/Register
            </button>
          </div>
        </nav>
      ...
      <div className="absolute top-0 left-0 h-[320px] w-full md:h-[600px]">
        <div className="relative h-[320px] md:h-[600px]">
          ...
          />
          <div className="absolute inset-0 z-30 flex flex-col items-center justify-center gap-y-6">
            <h1 className="text-body-3xl font-bold text-[#ffffff] md:text-heading-2">
              Dubai'de Dubai Frame'i keşfet
            </h1>
            <button className="flex h-11 items-center justify-start gap-x-2 rounded-full bg-[#ffffff] px-4 text-size-sm font-normal text-gray-600 md:h-13 md:w-[560px] md:text-size">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="18"
          ...
          <div className="absolute -bottom-px left-0 z-30 w-full">
            ...
            >
              <Link
                to="/$lang"
                className="group flex min-w-[132px] items-center gap-x-2 px-6 py-3 text-btn-white transition-colors duration-300 ease-in hover:bg-white-20 data-[status=active]:bg-box-surface data-[status=active]:text-btn-primary"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="17"
